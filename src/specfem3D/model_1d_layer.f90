...
! Warning: If you change velocity model in this folder, you will have to change the same file in ../specfem3d  Kangchen
...
TABLE=reshape((/(/0,4000,16000,30000,42000,45000,80000,80000,80000,80000,1000000/),&
