...
subroutine compute_diagonal_K2(iphase, &
  ...
  use specfem_par, only : PI,FULL_ATTENUATION_SOLID
...
!                    write(*,*) MASKX(1,iglob)
        ...
        do t=1,2
            do u=1,2
              ...
              kappal = kappastore(M(v),M(u),M(t),ispec)
              mul = mustore(M(v),M(u),M(t),ispec)
...
end subroutine compute_diagonal_K2
