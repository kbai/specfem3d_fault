...
! seismograms
  real(kind=CUSTOM_REAL), dimension(:,:,:), allocatable :: seismograms_d,seismograms_v,seismograms_a,seismograms_nstress,seismograms_sstress
...
! displacement, velocity, acceleration
  real(kind=CUSTOM_REAL), dimension(:,:), allocatable :: displ,veloc,accel,load
...
! shakemovies and movie surface
  ...
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stressxx_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stressyy_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stresszz_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stressxy_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stressyz_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stressxz_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stressxx_all_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stressyy_all_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stresszz_all_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stressxy_all_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stressyz_all_external_mesh
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: store_val_stressxz_all_external_mesh
