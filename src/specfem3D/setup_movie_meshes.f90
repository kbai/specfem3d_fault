...
! initializes mesh arrays for movies and shakemaps
  ...
  if (nfaces_surface_ext_mesh == 0) then
    ...
    if (USE_HIGHRES_FOR_MOVIES) then
      allocate(faces_surface_ext_mesh(NGLLX*NGLLY,1), &
        ...
        store_val_stressxz_external_mesh(NGLLX*NGLLY*1),&             
        store_val_stressyz_external_mesh(NGLLX*NGLLY*1),&          
        store_val_stresszz_external_mesh(NGLLX*NGLLY*1),stat=ier)
      ...
      allocate(faces_surface_ext_mesh(NGNOD2D_FOUR_CORNERS,1), &
        ...
        store_val_stressxz_external_mesh(NGNOD2D_FOUR_CORNERS*1),&             
        store_val_stressyz_external_mesh(NGNOD2D_FOUR_CORNERS*1),&          
        store_val_stresszz_external_mesh(NGNOD2D_FOUR_CORNERS*1),stat=ier)
    ...
    if (USE_HIGHRES_FOR_MOVIES) then
      allocate(faces_surface_ext_mesh(NGLLX*NGLLY,nfaces_surface_ext_mesh), &
        ...
        store_val_stressxz_external_mesh(NGLLX*NGLLY*nfaces_surface_ext_mesh),&             
        store_val_stressyz_external_mesh(NGLLX*NGLLY*nfaces_surface_ext_mesh),&          
        store_val_stresszz_external_mesh(NGLLX*NGLLY*nfaces_surface_ext_mesh),stat=ier)
      ...
      allocate(faces_surface_ext_mesh(NGNOD2D_FOUR_CORNERS,nfaces_surface_ext_mesh), &
        ...
        store_val_stressxz_external_mesh(NGNOD2D_FOUR_CORNERS*nfaces_surface_ext_mesh),&             
        store_val_stressyz_external_mesh(NGNOD2D_FOUR_CORNERS*nfaces_surface_ext_mesh),&          
        store_val_stresszz_external_mesh(NGNOD2D_FOUR_CORNERS*nfaces_surface_ext_mesh),stat=ier)
  ...
  store_val_stressxz_external_mesh(:)= 0._CUSTOM_REAL
  store_val_stressyz_external_mesh(:)= 0._CUSTOM_REAL
  store_val_stresszz_external_mesh(:)= 0._CUSTOM_REAL
  ...
  if (myrank == 0) then
    if (USE_HIGHRES_FOR_MOVIES) then
      ...
      allocate(store_val_coulomb_all_external_mesh(NGLLX*NGLLY*nfaces_surface_glob_ext_mesh), &
        ...
        store_val_stressxz_all_external_mesh(NGLLX*NGLLY*nfaces_surface_glob_ext_mesh), &
        store_val_stressyz_all_external_mesh(NGLLX*NGLLY*nfaces_surface_glob_ext_mesh),stat=ier)
      ...
      allocate(store_val_x_all_external_mesh(NGNOD2D_FOUR_CORNERS*nfaces_surface_glob_ext_mesh), &
        ...
        store_val_stressxz_all_external_mesh(NGNOD2D_FOUR_CORNERS*nfaces_surface_glob_ext_mesh),&             
        store_val_stressyz_all_external_mesh(NGNOD2D_FOUR_CORNERS*nfaces_surface_glob_ext_mesh),&          
        store_val_stresszz_all_external_mesh(NGNOD2D_FOUR_CORNERS*nfaces_surface_glob_ext_mesh),stat=ier)
      if( ier /= 0 ) stop 'error allocating arrays for lowres movie'
    endif
  endif
